...
/datum/controller/subsystem/mapping/add_new_zlevel(name, z_type = /datum/space_level, allocation_type = ALLOCATION_FREE)
	.=..()
...
/datum/controller/subsystem/mapping/get_level(z)
	.=..()
