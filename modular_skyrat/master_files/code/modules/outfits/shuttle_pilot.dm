...
/obj/item/clothing/under/rank/utility_tan
	...
	armor_type = list(MELEE = 10, BULLET = 0, LASER = 0, ENERGY = 0, BOMB = 10, BIO = 10, FIRE = 30, ACID = 30, WOUND = 10)
	strip_delay = 70
...
/obj/item/clothing/suit/armor/vest/tan
	...
	armor_type = list(MELEE = 40, BULLET = 40, LASER = 40, ENERGY = 40, BOMB = 40, BIO = 0, FIRE = 80, ACID = 100, WOUND = 30)
